...
1. Скачайте установщик желаемой версии (рекомендуется скачивать последнюю доступную на данный момент), который вы можете найти в разделе Assets желаемой версии [по ссылке](https://github.com/INFOCOT/OnTheCatsTrail/releases/tag/OnTheCatsTrail-Release)
